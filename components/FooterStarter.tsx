  ...
  return (
    <footer id="footer" style={{ background: 'linear-gradient(180deg, #1c1008 0%, #0a0502 100%)' }}>
      ...
      <div className="relative w-full" style={{ height: '380px' }}>
        ...
        {/* Buton Deschide în Maps peste hartă */}
        <div className="absolute bottom-5 right-5">
          <a
            href="https://maps.google.com/?q=2+Pound+Hill+Parade+Crawley+RH10+7EA+UK"
            target="_blank"
            rel="noopener noreferrer"
            className="px-5 py-2.5 rounded-2xl text-amber-400 font-bold text-xs tracking-wide transition-all hover:scale-105 border border-amber-400/40 hover:border-amber-400"
            style={{ background: 'rgba(28,16,8,0.85)', backdropFilter: 'blur(8px)' }}
          >
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <h3 className="text-2xl font-black text-white mt-2" style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-12">
          ...
          <div className="rounded-3xl p-7" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(245,158,11,0.15)' }}>
            ...
            <h4 className="text-xs font-bold uppercase tracking-[0.3em] text-amber-500 mb-5">Contact</h4>
          ...
          <div className="rounded-3xl p-7" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(245,158,11,0.15)' }}>
            <div className="w-8 h-px bg-amber-400 mb-4" />
            <h4 className="text-xs font-bold uppercase tracking-[0.3em] text-amber-500 mb-5">Program</h4>
            <div className="flex flex-col gap-2 text-sm">
              {[
                { z: 'Luni – Vineri', o: '07:00 – 20:00' },
                { z: 'Sâmbătă', o: '08:00 – 21:00' },
                { z: 'Duminică', o: '09:00 – 18:00' },
              ].map(({ z, o }) => (
          ...
          <div className="rounded-3xl p-7 flex flex-col justify-between" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(245,158,11,0.15)' }}>
            <div>
              <div className="w-8 h-px bg-amber-400 mb-4" />
              <h4 className="text-xs font-bold uppercase tracking-[0.3em] text-amber-500 mb-5">Rezervări</h4>
              <p className="text-white/40 text-sm leading-relaxed mb-8">
                Rezervă un loc în avans și bucură-te de experiența completă Vibe Caffè.
              </p>
            </div>
            <a
              href="/rezervari"
              className="w-full text-center py-4 rounded-2xl text-sm font-bold text-black transition-all hover:scale-105 hover:shadow-[0_8px_30px_rgba(245,158,11,0.4)]"
        ...
        {/* Social buttons centrate jos */}
        <div className="flex gap-3 justify-center mt-8">
          <a href="https://wa.me/447706644224" target="_blank" rel="noopener noreferrer"
            className="w-11 h-11 rounded-xl flex items-center justify-center transition-all hover:scale-110 hover:shadow-[0_6px_20px_rgba(37,211,102,0.4)]"
          ...
          <a href="https://www.instagram.com/olgalux_aesthetics?igsh=aXNveWc3M3dya3l4&utm_source=qr" target="_blank" rel="noopener noreferrer"
            className="w-11 h-11 rounded-xl flex items-center justify-center transition-all hover:scale-110 hover:shadow-[0_6px_20px_rgba(253,29,29,0.4)]"
          ...
          <a href="https://tiktok.com/@olgalux10" target="_blank" rel="noopener noreferrer"
            className="w-11 h-11 rounded-xl flex items-center justify-center transition-all hover:scale-110"
            style={{ background: 'transparent', border: '1px solid rgba(245,158,11,0.5)' }}>
          ...
          <a href="https://www.facebook.com/share/1Bmna1F7D4/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer"
            className="w-11 h-11 rounded-xl flex items-center justify-center transition-all hover:scale-110 hover:shadow-[0_6px_20px_rgba(24,119,242,0.4)]"
